...
print(f"The number of loans right now is {number_of_loans}.")
...
print(f"The total amount of loans is ${total_amount_of_loans}.")
...
# YOUR CODE HERE!
print("Writing the list of inexpensive loans to a CSV file...")
